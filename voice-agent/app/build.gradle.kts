...
android {
    namespace = "com.voiceagent.gemini"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.voiceagent.gemini"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // WebView asset loader (serves assets via virtual HTTPS for ES modules + mic)
    implementation("androidx.webkit:webkit:1.12.1")

    // OkHttp (settings test connection only)
